...
node --test test/textMatch.test.js test/tradeTargeter.test.js test/turnDetect.test.js test/topPicks.test.js test/byes.test.js test/yahooPool.test.js test/consensusAdp.test.js test/sweepTrust.test.js
